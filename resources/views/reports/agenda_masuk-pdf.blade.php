...
<head>
    ...
    <title>Daftar Agenda Surat Masuk</title>
    <style>
        h1, h2, h3, h4, h5, h6 {
            text-align: center;
        }
...
<body>
<h1 style="margin-bottom: 5px">Daftar Agenda Surat Masuk</h1>
    ...
    @foreach($ag_masuks as $row)
        <tr>
            ...
            <td style="vertical-align: middle">
                <strong>{{$row->getSuratDisposisi->getSuratMasuk->no_surat}}</strong><br>
                {{\Carbon\Carbon::parse($row->getSuratDisposisi->getSuratMasuk->tgl_surat)->format('j F Y')}}</td>
